    ...
    .then((resolve) => {
      resolve.forEach((item) => {
        ...
        <div class="main__assort-mainContent-favorites">
            <span data-id="${item.id}" class="main__assort-mainContent-favorites-logo addFavorite"><svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const getBasket = () => {
  ...
  basketData.forEach((item) => {
    ...
    <img src="${item.images}" alt="" class="basket__card-img">
